...
for _, player in ipairs(players) do
    ...
    local playerFolder = workspace.Debree.clash_folder[playerName .. "vsEnmu"]

    if playerFolder then
        local ohInstance2 = playerFolder:FindFirstChild(playerName)
        if ohInstance2 then
            local ohNumber3 = 300
            ...
            if not success then
                warn("Erro ao executar o script para o jogador " .. playerName .. ": " .. error)
            end
        end
    end
end
